...
class OverlayService : Service() {
    ...
    private fun buildNotification(): Notification { val cId = "haval_dash_overlay"; val nm = getSystemService(NotificationManager::class.java); if (nm.getNotificationChannel(cId) == null) nm.createNotificationChannel(NotificationChannel(cId, "Haval Dash", NotificationManager.IMPORTANCE_MIN)); return Notification.Builder(this, cId).setContentTitle("Haval Dock").setContentText("Barra inferior ativa").setSmallIcon(R.mipmap.ic_launcher).setOngoing(true).build() }
