...
object DockControls {
    ...
    val MONITORED: List<String> = listOf(
        ...
        DockKeys.CAR_HVAC_POWER_MODE,
        DockKeys.CAR_HVAC_AC_ENABLE,
        DockKeys.CAR_HVAC_SYNC_ENABLE,
        ...
        DockKeys.CAR_EV_INFO_ELECTRIC_MODE_REMAIN_ODOMETER,
        DockKeys.CAR_EV_INFO_CHARGE_REMAINING_TIME,
    ...
    val DEBUG_VARIABLES: Map<String, Map<String, String>> = linkedMapOf(
        "CONSUMO E COMBUSTÍVEL" to linkedMapOf(
            "1AVG FUEL CONSUMPTION" to DockKeys.CAR_BASIC_AVG_FUEL_CONSUMPTION,
            "2CUR JOURNEY AVG FUEL" to DockKeys.CAR_BASIC_CUR_JOURNEY_AVG_FUEL_CONSUME,
            "3INSTANT FUEL" to DockKeys.CAR_BASIC_INSTANT_FUEL_CONSUMPTION,
            "4REMAIN FUEL %" to DockKeys.CAR_BASIC_REMAIN_FUEL_PERCENTAGE,
            "5CYCLE FUEL CONSUME" to DockKeys.CAR_EV_INFO_CYCLE_FUEL_CONSUME_INFO,
            "6FUEL CONSUME INFO" to DockKeys.CAR_EV_INFO_FUEL_CONSUME_INFO
        ),
        ...
        "EV-INFO" to linkedMapOf(
          ...
          //  "ENERGY CONSUME" to DockKeys.CAR_EV_INFO_ENERGY_CONSUME_INFO,
            "ENERGY RECOVERY" to DockKeys.CAR_EV_INFO_ENERGY_RECOVERY_INFO,
